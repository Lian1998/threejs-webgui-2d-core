...
export interface SDFText2DGenMaterialParameters extends THREE.ShaderMaterialParameters {
  /** 字符串贴图 */
...
export class SDFText2DGenMaterial extends THREE.ShaderMaterial {
  constructor(parameters: SDFText2DGenMaterialParameters) {
    super({
      name: "SDFText2DGenMaterial",
